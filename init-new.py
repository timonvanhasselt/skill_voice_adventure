...
class VoiceAdventureSkill(OVOSSkill):
    ...
    def handle_start_game_intent(self, message):
        ...
        self.play_audio_files_sequentially([QUESTION_1_AUDIO_PATHS["intro"], QUESTION_1_AUDIO_PATHS["question"]])

    def play_audio_files_sequentially(self, audio_files):
    ...
    def ask_question(self):
        ...
        self.play_audio_files_sequentially([question_info["question"]])
        ...
        self.play_audio_files_sequentially(options)
    ...
    def handle_answer(self, is_correct):
        ...
        if is_correct:
            self.play_audio_files_sequentially([question_info["correct_answer"]])
            self.score += 1
        else:
            self.play_audio_files_sequentially([question_info["incorrect_answer"]])
